...
class TSPSolver3D():
    ...
    def clusterViewpoints(self, problem, viewpoints, method):
        ...
        if method == 'kmeans':
            ...
            #raise NotImplementedError('[STUDENTS DONE] KMeans clustering of viewpoints not implemented. You have to finish it on your own')
            # Tips:
            ...
            # DONE: fill 1D list 'labels' of size len(viewpoints) with indices of the robots
